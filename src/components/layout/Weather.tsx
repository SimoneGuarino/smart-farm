...
const weatherIcons: Record<WeatherType, React.ReactNode> = {
    sunny: <WiDaySunny size={120} color="#fbbf24" />,
    cloudy: <WiCloud size={120} color="#64748b" />,
    rain: <WiRain size={120} color="#38bdf8" />,
    snow: <WiSnow size={120} color="#a3e635" />,
    thunderstorm: <WiThunderstorm size={120} color="#f87171" />,
    fog: <WiFog size={120} color="#94a3b8" />,
};
